all:
	...
	ld -s -Ttext 0x8000 -o kernel.elf -melf_i386 kernel.o interupt.o lib.o interupt_entry.o libc.o protected.o task.o sys_call.o sys_call_entry.o time.o keyboard.o
